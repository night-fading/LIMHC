...
if __name__ == "__main__":
    ...
    img_t = T.Resize(size=(256, 256))(
        read_image("/Users/leizhe/fsdownload/2007_007818.jpg", mode=ImageReadMode.RGB).to(torch.float32) / 255)

    img = jpeg(img_t.unsqueeze(0))
    img = T.ToPILImage()(img.squeeze(0))
    img.save("/Users/leizhe/fsdownload/test.png")
